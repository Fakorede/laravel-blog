                    ...
                    <div class="blog-details-author-content">
                        ...
                        <div class="socials">
                            ...
                            <a href="{{ $post->user->profile->facebook }}" class="social__item" target="_blank">
                                <img src="{{ asset('app/svg/facebook.svg') }}" alt="facebook">
                            </a>
                            ...
                            <a href="{{ $post->user->profile->medium }}" class="social__item" target="_blank">
                                <img src="{{ asset('app/svg/medium.svg') }}" alt="medium">
                            </a>

                            <a href="{{ $post->user->profile->github }}" class="social__item" target="_blank">
                                <img src="{{ asset('app/svg/github.svg') }}" alt="github">
                            </a>
