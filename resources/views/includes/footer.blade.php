            ...
            <div class="contacts">
                <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                    <div class="contacts-item">
                        ...
                        <div class="content">
                            <a href="#" class="title" style="font-size:18px;">{{ $settings->contact_number }}</a>
                            <p class="sub-title">Reach Me</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                    <div class="contacts-item">
                        ...
                        <div class="content">
                            <a href="#" class="title" style="font-size:18px;">{{ $settings->contact_email }}</a>
                            <p class="sub-title">Drop a Mail</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                    <div class="contacts-item">
                        ...
                        <div class="content">
                            <a href="#" class="title" style="font-size:18px;">{{ $settings->address }}</a>
                            <p class="sub-title">Current Location</p>
                        </div>
                    </div>
                </div>
            </div>
